...
public class NotificationFragment extends Fragment {
    ...
    private NotificationFragment galleryViewModel;
    ...
    int[] images = {R.drawable.noti_1, R.drawable.noti_2, R.drawable.noti_3,R.drawable.noti_1, R.drawable.noti_2};
    ...
    String[] versionNumber = {"sent you connection", "Has invite you to participate in challenge", "The membership rules", "smaple connection", "testing notification"};
...
class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.child_notificationlist_item, parent, false);
...
class CustomAdapterNotification extends ArrayAdapter<RpmModule> implements View.OnClickListener{
    ...
    public CustomAdapterNotification(ArrayList<RpmModule> data, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CustomAdapterNotification.ViewHolder viewHolder; // view lookup cache stored in tag

        final View result;

        if (convertView == null) {

            viewHolder = new CustomAdapterNotification.ViewHolder();
            ...
            viewHolder = (CustomAdapterNotification.ViewHolder) convertView.getTag();
            result=convertView;
        }
