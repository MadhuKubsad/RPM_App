...
public class ChallengeStatusModel implements Serializable {
  ...
  public ChallengeStatusModel id(Long id) {
  ...
  **/
  ...
  public ChallengeStatusModel challengeStatus(String challengeStatus) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChallengeStatusModel challengeStatusModel = (ChallengeStatusModel) o;
    return Objects.equals(this.id, challengeStatusModel.id) &&
        Objects.equals(this.challengeStatus, challengeStatusModel.challengeStatus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, challengeStatus);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ChallengeStatusModel {\n");
